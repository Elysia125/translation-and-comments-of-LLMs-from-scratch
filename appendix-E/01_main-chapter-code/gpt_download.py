...
# 导入第三方库
# import requests  # 注释掉的requests库,提供了另一种HTTP请求方式
...
def download_and_load_gpt2(model_size, models_dir):
    ...
    base_url = "https://openaipublic.blob.core.windows.net/gpt-2/models"  # GPT-2模型的基础URL
    # 需要下载的文件列表
    filenames = [
    ...
    # 下载所有必需文件
    os.makedirs(model_dir, exist_ok=True)  # 创建保存目录(如果不存在)
